...
TYPE_LIST = {
    "INCOME": "INCOME", "ENTRADA": "INCOME", "RECEITA": "INCOME", "SÁLARIO": "INCOME",
...
def _resolve_category_id(cur, category_id: Optional[int] = None, category_name: Optional[str] = None) -> Optional[int]:
    if category_id:
        return category_id
...
class AddTransactionArgs(BaseModel):
    ...
    type_id: Optional[int] = Field(default=None, description="ID em transaction_types (opcional) (1=INCOME, 2=EXPENSES, 3=TRANSFER).")
    type_name: Optional[str] = Field(default=None, description="Nome do tipo (opcional) : INCOME | EXPENSES | TRANSFER.")
    category_id: Optional[int] = Field(default=None, description="FK de categories (opcional):  (1=comida, 2=besteira, 3=estudo, 4=férias, 5=transporte, 6=moradia, 7=saúde, 8=lazer, 9=contas, 10=investimento, 11=presente, 12=outros)")
    category_name: Optional[str] = Field(default=None, description="Nome da categories (opcional) : (comida, besteira, estudo, férias, transporte, moradia, saúde, lazer, contas, investimento, presente, outros)")
